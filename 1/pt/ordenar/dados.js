...
const JOGO_ORDEM_DATA = {
    categorias: {
        ...
        cat3: { id: 'cat3', nome: '3. Mesma Letra Inicial', titulo: 'Dicionário Mágico' },
    ...
    bancoGeral: ["Abelha", "Bola", "Cachorro", "Dado", "Elefante", "Foca", "Gato", "Hipopótamo", "Jacaré", "Leão", "Macaco", "Navio", "Ovo", "Pato", "Queijo", "Rato", "Sapo", "Tigre", "Uva", "Vaca", "Zebra"]
};
