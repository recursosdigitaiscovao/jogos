const CONFIG_MESTRE = {
    ano: "ano1",        
    area: "portugues",  // Define a cor fixa do template
    tema_jogo: "animais", // O tema das cartas selecionado
    nivel: "nivel1",      // O nível selecionado
...
const BIBLIOTECA_CONTEUDO = {
    "ano1": {
        "portugues": { t1: "JOGO DA", t2: "MEMÓRIA", sub: "Imagem + Palavra", intro: "Escolhe o tema e o nível no botão azul (RD)!" }
    }
};
