const JOGO_CONFIG = {
    ...
    categorias: {
        animais: {
            ...
            itens: [{letras:"CÃO"},{letras:"GATO"},{letras:"PATO"},{letras:"PERU"},{letras:"VACA"},{letras:"COELHO"},{letras:"CABRA"},{letras:"PORCO"},{letras:"OVELHA"},{letras:"GALO"},{letras:"GALINHA"},{letras:"BURRO"},{letras:"CAVALO"},{letras:"RATO"},{letras:"PEIXE"},{letras:"POMBO"},{letras:"CANÁRIO"},{letras:"HAMSTER"},{letras:"PÔNEI"},{letras:"CÁGADO"}]
        },
        frutos: {
            nome: "Frutos", imgCapa: "frutas/maca.png",
            itens: [{letras:"MAÇÃ"},{letras:"PÊRA"},{letras:"UVA"},{letras:"FIGO"},{letras:"MELÃO"},{letras:"BANANA"},{letras:"LARANJA"},{letras:"MORANGO"},{letras:"CEREJA"},{letras:"ANANÁS"},{letras:"LIMÃO"},{letras:"PÊSSEGO"},{letras:"AMEIXA"},{letras:"KIWI"},{letras:"MANGA"},{letras:"PAPAIA"},{letras:"MELANCIA"},{letras:"AMORA"},{letras:"FRAMBOESA"},{letras:"ROMÃ"}]
        },
        material: {
            nome: "Material Escolar", imgCapa: "materialescolar/lapis.png",
            itens: [{letras:"AFIA"},{letras:"LÁPIS"},{letras:"RÉGUA"},{letras:"COLA"},{letras:"LIVRO"},{letras:"CADERNO"},{letras:"MOCHILA"},{letras:"TESOURA"},{letras:"BORRACHA"},{letras:"ESTOJO"},{letras:"CANETA"},{letras:"MARCADOR"},{letras:"QUADRO"},{letras:"GIZ"},{letras:"PINCEL"},{letras:"PASTA"},{letras:"TINTA"},{letras:"MAPA"},{letras:"AGRAFADOR"},{letras:"COMPASSO"}]
        },
        selvagens: {
            nome: "Selvagens", imgCapa: "animaisselvagens/leao.png",
    ...
    relatorios: [
        { min: 800, titulo: "BRILHANTE!", img: "taca_1.png" },
        { min: 500, titulo: "MUITO BEM!", img: "taca_2.png" },
        { min: 200, titulo: "BOM TRABALHO!", img: "taca_3.png" },
