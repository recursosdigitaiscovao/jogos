const JOGO_CONFIG = {
    ...
    relatorios: [
        { min: 90, titulo: "BRILHANTE!", msg: "És um verdadeiro mestre das palavras!", img: "taca_1.png" },
        { min: 70, titulo: "MUITO BEM!", msg: "Excelente prestação!", img: "taca_2.png" },
        { min: 50, titulo: "BOM TRABALHO!", msg: "Estás quase lá, continua a praticar!", img: "taca_3.png" },
