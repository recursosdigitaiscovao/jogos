...
const DESAFIOS_FABRICA = {
    nivel1: [
        ...
        { bank: ["PEI", "XE", "E", "RE"], slots: 2 },        // Palavra-Mestre: PEIXE (Derivadas: PEPE, REI, EIXO)
        { bank: ["CO", "E", "LHO", "LA"], slots: 3 },       // Palavra-Mestre: COELHO (Derivadas: COLA, HELO, ECHO)
    ...
    nivel2: [
        ...
        { bank: ["CRO", "CO", "DI", "LO", "MA"], slots: 4 },// Palavra-Mestre: CROCODILO (Derivadas: COLO, LAMA, DILO)
        ...
        { bank: ["BA", "LEI", "A", "MA", "RE"], slots: 3 }, // Palavra-Mestre: BALEIA (Derivadas: BALA, LEIA, MARE, MEIA)
